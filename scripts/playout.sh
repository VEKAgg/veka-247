...
while true; do
  ...
  # Multi-platform (uncomment and replace -f flv line above):
  # -f tee "[f=flv]rtmp://live.twitch.tv/app/${TW_KEY}|[f=flv]${YT_KEY}|[f=flv]${KICK_KEY}"

  echo "ffmpeg exited (code $?), reshuffling and restarting in 3s..." >&2
  sleep 3
done
